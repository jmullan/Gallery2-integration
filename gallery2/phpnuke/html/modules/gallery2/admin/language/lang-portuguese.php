 ...
 */
/*
 * Ficheiro de linguagem portuguesa do modulo Gallery 2 para o PhpNuke. 
...
define("_UPDATEEMBEDSETTINGSG2","Verificar as settings da instalaчуo ou update da tua Gallery2 "); 
...
define("_NOTWRITABLE","Nуo permite a escrita"); 
define("_CFG_UPDATED","Ficheiro de configuraчуo actualizado "); 
define("_USER_EXPORT_UPDATED","Utilizadores estуo sincronizados"); 
...
define("_SHOWSIDEBAR","Mostrar barra lateriar (Nуo selecionar se estiveres a usar o block lateral do Gallery2)"); 

define("_G2_EMBED_PHP_FILE","embed.php"); 
define("_G2_CONFIGURATION_NOT_DONE","Este modulo ainda nуo foi configurado.");
