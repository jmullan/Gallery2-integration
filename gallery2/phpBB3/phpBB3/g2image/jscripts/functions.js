		...
		if ((loop == 1) || obj.images[i].checked) {
			...
			switch(obj.imginsert.value){
				case 'thumbnail_image':
					htmlCode += '[url=' + image_url[i] + ']';
					htmlCode += '[img]'+ thumbnail_src[i] + thumbw[i] + thumbh[i];
					htmlCode += '[/img][/url]';
				break;
				case 'thumbnail_album':
					htmlCode += '[url=' + obj.album_url.value + ']';
					htmlCode += '[img]'+thumbnail_src[i] + thumbw[i] + thumbh[i];
					htmlCode += '[/img][/url]';
				break;
				...
				case 'fullsize_image':
					htmlCode += '[url=' + image_url[i] + ']';
					htmlCode += '[img]' + fullsize_img[i] + thumbw[i] + thumbh[i];
					htmlCode += '[/img][/url]';
				break;
				case 'thumbnail_custom_url':
					htmlCode += '[url=' + obj.custom_url.value + ']';
					htmlCode += '[img]' + thumbnail_src[i] + thumbw[i] + thumbh[i];
					htmlCode += '[/img][/url]';
				break;
				case 'thumbnail_only':
				...
				break;
				case 'link_image':
					htmlCode += '[url=' + image_url[i] + ']' + obj.link_text.value + '[/url]';
				break;
				case 'link_album':
					htmlCode += '[url=' + obj.album_url.value + ']' + obj.link_text.value + '[/url]';
				break;
				default:
					htmlCode += 'Error';
				break;
